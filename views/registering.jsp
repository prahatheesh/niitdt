  ...
  <div class="container-fluid">
   ...
   <li class="active"><a href="royalenfield">HOME</a></li>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="registering"><span class="glyphicon glyphicon-user"></span> Join Us</a></li>
      <li><a href="NewFile"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
    </ul>
  </div>
</nav>
...
<body>
 ...
 <div  class="form">
       ...
       <input type="text"  name="username" placeholder="First and last name" required="" autofocus="" id="name" name="name" tabindex="1"/>
                ...
                <div class="contact"><label>Confirm password</label> </div>
